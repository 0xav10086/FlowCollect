...
function computedWithControl(source, fn) {
	...
	const set$3 = typeof fn === "function" ? void 0 : fn.set;
...
function extendRef(ref$1, extend, { enumerable = false, unwrap = true } = {}) {
	if (!isVue3$1 && !version.startsWith("2.7.")) throw new Error("[VueUse] extendRef only works in Vue 2.7 or above.");
...
function refWithControl(initial, options = {}) {
	...
	function set$3(value, triggering = true) {
		var _a, _b;
	...
	const silentSet = (v) => set$3(v, false);
	const peek = () => get$1(false);
	const lay = (v) => set$3(v, false);
...
function set$2(...args) {
	...
	if (args.length === 3) if (isVue2$1) set$1(...args);
	else {
...
function useCounter(initialValue = 0, options = {}) {
	...
	const set$3 = (val) => count.value = Math.max(min, Math.min(max, val));
...
//#endregion
//#region node_modules/@vueuse/core/node_modules/vue-demi/lib/index.mjs
var isVue2 = false;
var isVue3 = true;
...
function useCycleList(list, options) {
	...
	function shift(delta = 1) {
		return set$3(index.value + delta);
	}
	function next(n = 1) {
		return shift(n);
	}
	...
	watch(listRef, () => set$3(index.value));
	return {
		state,
		index,
		next,

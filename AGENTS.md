...
这个文档没用了，我开始现写提示词了，谁发明了vibe coding，简直是一个灾难，光是写提示词我就力竭了，根本不能像以前一样编写边debug了，只能靠着agent的最后汇总来分析有没有满足我的需求了。因为我已经力竭了，所以大概率是没有满足，要么我自己改，要么重写提示词。😔，满纸荒唐言，一把辛酸泪，只希望该项目能满足我自己的需求吧。
